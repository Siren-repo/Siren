...
class ItemServiceImplTest {
  ...
  private static void setUp() {
    ...
    inValidObject =
        new ItemCreateRequest(
            new CategoryCreateRequest(CategoryType.of("음료"), "dd"),
            "아메리카노",
            -5,
            "아메리카노입니다",
            null,
        ...
        Item.builder()
            ...
            .category(
                Category.builder()
                    ...
                    .categoryType(validObject.getCategoryRequest().getCategoryType())
                    .build())
            .defaultOption(
            ...
            .allergies(allergyConverter.convertToEntityAttribute(validObject.getAllergy()))
            .build();
    // When

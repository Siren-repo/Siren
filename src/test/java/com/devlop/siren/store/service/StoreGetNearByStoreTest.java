...
public class StoreGetNearByStoreTest {
  ...
  public void 주변_매장_2KM() {
    ...
    when(storeRepository.findAll())
        .thenReturn(Arrays.asList(mockStore1, mockStore2, mockStore3, mockStore4));
    ...
    List<Store> nearbyStores =
        storeService.getNearbyStores(centerLatitude, centerLongitude, radiusInKm);

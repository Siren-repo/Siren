...
public class RedisConfig {
    ...
    public RedisTemplate<String, ItemDto> cartRedisTemplate(){
        ...
        // Value Serializer 설정
        Jackson2JsonRedisSerializer<ItemDto> jsonRedisSerializer = new Jackson2JsonRedisSerializer<>(ItemDto.class);

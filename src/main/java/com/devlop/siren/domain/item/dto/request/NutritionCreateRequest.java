...
public class NutritionCreateRequest {
  ...
  public static Nutrition toEntity(NutritionCreateRequest nutrition) {
    return Nutrition.builder()
        ...
        .carbohydrate(
            nutrition.addUnit(nutrition.getCarbohydrate(), NutritionCreateRequest.Unit.GRAM))
        ...
        .cholesterol(
            nutrition.addUnit(nutrition.getCholesterol(), NutritionCreateRequest.Unit.MILLI_GRAM))
        .transFat(nutrition.addUnit(nutrition.getTransFat(), NutritionCreateRequest.Unit.GRAM))
        .caffeine(
            nutrition.addUnit(nutrition.getCaffeine(), NutritionCreateRequest.Unit.MILLI_GRAM))
        .saturatedFat(
            nutrition.addUnit(nutrition.getSaturatedFat(), NutritionCreateRequest.Unit.GRAM))
        .build();
  }
}

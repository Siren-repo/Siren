...
public interface ItemRepository extends JpaRepository<Item, Long> {
    ...
    @Query("select i from Item i join fetch i.category c where c.categoryType = :categoryType and c.categoryName = :categoryName ")
    Optional<List<Item>> findAllByItemTypeAndCategoryName(@Param("categoryType") CategoryType categoryType,
